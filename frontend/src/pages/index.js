...
function ShareButton({ children = 'Add your token' }) {
  let href = `https://github.com/albertocevallos/token-icons/issues/new`
    ...
    <header className="relative overflow-hidden bg-slate-50 pt-6">
      ...
      <Container className="relative">
        <div className="relative z-10 flex items-center justify-between">
          ...
          <ShareButton>
            Add<span className="sr-only sm:not-sr-only"> your token</span>
          </ShareButton>
        </div>
    ...
    return (
      <div className="flex flex-col items-center py-20 text-sm leading-6 text-slate-600 md:py-32 lg:py-40">
        ...
        <p className="mt-1">
          ...
          <Link
            href="https://github.com/albertocevallos/token-icons/issues/new"
